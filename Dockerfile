...
COPY local.py /var/www/Praktomat/src/settings \
 && defaults.py /var/www/Praktomat/src/settings \
 && Builder.py /var/www/Praktomat/src/checker/compiler \
 && CBuilder.py /var/www/Praktomat/src/checker/compiler\
 && manage-local.py /var/www/Praktomat/src
